...
function runGraph() {
  ...
  local SED_EX2='s/shape = "box"/shape = "box", style = "filled", fillcolor = "deepskyblue"/'
  local SED_EX3='s/shape = "diamond"/shape = "diamond", style = "filled", fillcolor = "aquamarine"/'
  local OUT_FILE="${THIS_DIR}/"${PWD##*/}".png"
